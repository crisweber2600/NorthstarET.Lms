...
public class DistrictProvisioningContractTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    [Fact]
    public void POST_Districts_ShouldReturn201_WhenValidRequest()
    {
    ...
    [Fact]
    public void POST_Districts_ShouldReturn409_WhenSlugAlreadyExists()
    {
    ...
    [Fact]
    public void POST_Districts_ShouldReturn422_WhenInvalidSlug()
    {
    ...
    [Fact]
    public void PATCH_DistrictStatus_ShouldReturn202_WhenValidStatusUpdate()
    {
    ...
    [Fact]
    public void PATCH_DistrictStatus_ShouldReturn409_WhenLegalHoldPreventsStatusChange()
    {
    ...
    [Fact]
    public void District_API_ShouldMatchOpenAPISchema()
    {
    ...
    [Fact]
    public void District_API_ShouldRequireAuthentication()
    {
    ...
    [Fact]
    public void District_API_ShouldEnforceRBAC()
    {
    ...
    [Fact]
    public void District_API_ShouldAuditAllOperations()
    {
    ...
    [Fact]
    public void District_API_ShouldValidateTenantContext()
    {
